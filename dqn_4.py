...
class Q(Chain):
    def __init__(self,state_num=INPUT_NODE):
        super(Q,self).__init__(
            ...
            l2=L.Linear(1024, 512), # 8192
            l3=L.Linear(512, 256), # 16384 -> 32768
            l4=L.Linear(256, 64), # 8192
            l5=L.Linear(64, 16), # 16384 -> 32768
            l6=L.Linear(16, 8), # 16384 -> 32768
...
class DQNAgent():
    ...
    def experience(self,x):
        if len(self.experienceMemory)>self.memSize:
            self.experienceMemory[int(self.memPos)]=x
            self.memPos=(self.memPos+1)%self.memSize
        else:
