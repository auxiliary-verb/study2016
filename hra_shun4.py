...
# 
KIND_OF_HEADS = 3*7 + KIND_OF_PAI + 1
...
class pendulumEnvironment():
    ...
    def get_koutu_reward(self,first_pai):
        oldkoutu = self.koutu[first_pai]
        self.koutu[first_pai] = self.get_koutu(first_pai)
        return self.koutu[first_pai] - oldkoutu
...
class simulator:
    ...
    def run(self, train=True, movie=False, enableLog=False):
        ...
        for i in range(27):
            ...
            for p in PAI_NUM2ACT:
                reward.append(self.env.get_koutu_reward(p))
